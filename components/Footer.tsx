...
/**
 * Footer — blue wave footer with columns and social icons.
 * Server Component.
 */
      ...
      <div className="mx-auto max-w-7xl px-4 pb-12 pt-2 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 text-center">
          <p className="text-2xl font-extrabold tracking-tight">
            Benticuaga{" "}
            <span className="font-semibold text-blue-200">LIBRERÍA</span>
          </p>
        ...
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-3">
          {Object.entries(links).map(([heading, items]) => (
            <div key={heading}>
              <p className="mb-4 text-xs font-bold uppercase tracking-widest text-blue-300">
                {heading}
              </p>
        ...
        {/* Divider */}
        <div className="my-8 border-t border-blue-500" />

        {/* Bottom row */}
        <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
          <p className="text-xs text-blue-300">
            © {new Date().getFullYear()} Benticuaga Librería. Todos los derechos reservados.
          </p>
