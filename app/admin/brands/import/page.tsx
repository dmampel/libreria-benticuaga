...
export default function AdminBrandImportPage() {
  const { user } = useAuth()
  ...
  return (
    <div className="p-8">
      <div className="mb-6 flex items-center gap-4">
        <Link href="/admin/brands" className="rounded-lg p-1.5 text-gray-400 hover:bg-gray-200 hover:text-gray-700">
          <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18" />
          </svg>
        </Link>
        <h1 className="text-2xl font-bold text-gray-900">Importar Marcas CSV</h1>
      </div>
...
{`name,image
Faber-Castell,https://ejemplo.com/logo.png
Mooving,
Stabilo,https://ejemplo.com/stabilo.png`}
          </pre>
          <ul className="mt-3 space-y-1 text-xs text-gray-500">
            <li><span className="font-medium text-gray-700">name</span> — requerido</li>
            <li><span className="font-medium text-gray-700">image</span> — opcional (URL del logo)</li>
            <li>Si la marca ya existe (mismo nombre), se actualiza. Si no, se crea.</li>
