...
function greeting(user: OrderEmailData["user"]) {
  if (user?.firstName) return `Hola ${user.firstName}`
  return "Hola"
}
...
export function getOrderConfirmationHTML(order: OrderEmailData): string {
  return wrapper(`
    <p style="margin: 0 0 8px; font-size: 18px; font-weight: 700; color: #111827;">${greeting(order.user)}, ¡recibimos tu pedido!</p>
...
export function getOrderShippedHTML(order: OrderEmailData, trackingNumber: string): string {
  return wrapper(`
    <p style="margin: 0 0 8px; font-size: 18px; font-weight: 700; color: #111827;">${greeting(order.user)}, ¡tu pedido fue despachado!</p>
...
export function getOrderDeliveredHTML(order: OrderEmailData): string {
  return wrapper(`
    <p style="margin: 0 0 8px; font-size: 18px; font-weight: 700; color: #111827;">${greeting(order.user)}, ¡tu pedido fue entregado!</p>
